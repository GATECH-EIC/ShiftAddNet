...
__all__ = ['resnet34_shiftadd_se', 'resnet18_shiftadd_se']
...
def resnet18_shiftadd_se(threshold, sign_threshold, distribution, num_classes=1000, quantize=False, weight_bits=8, sparsity=0, **kwargs):
...
def resnet34_shiftadd_se(threshold, sign_threshold, distribution, num_classes=1000, quantize=False, weight_bits=8, sparsity=0, **kwargs):
...
def resnet50_shiftadd_se(threshold, sign_threshold, distribution, num_classes=1000, quantize=False, weight_bits=8, sparsity=0, **kwargs):
