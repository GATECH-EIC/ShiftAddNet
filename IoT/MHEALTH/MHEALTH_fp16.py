...
def train(epoch, train_loader, model_params, master_params):
    model.train()
...
for i in range(0, len(folds)):
    ...
    model, optimizer, model_params, master_params = get_model()
    ...
    for epoch in range(epochs):
        ...
        train(epoch, train_loader, model_params, master_params)
        with torch.no_grad():
