...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, threshold, stride=1, downsample=None):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, threshold):
...
def resnet20_shift_se(threshold, num_classes=10, **kwargs):
